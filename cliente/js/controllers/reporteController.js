app.controller('reporteController', ['$scope', 'toaster', 'zonaService', 'funcionService',
      'reporteService', 'ngTableParams', 'excelService', 'contratoService',  function ($scope, toaster,
      zonaService, funcionService, reporteService, ngTableParams, excelService, contratoService) {
